...
benchmark_results = pd.read_csv('../../exprimo/experiment_results/sim_real_comp/resnet/benchmark_results.csv',
                                header=None)
simulated_times = pd.read_csv('../../exprimo/experiment_results/sim_real_comp/resnet/scores-half-bandwidth.csv',
...
all_scores = simulated_times.join(benchmark_avg, how='inner').sort_index()
